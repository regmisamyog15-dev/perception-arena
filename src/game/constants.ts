...
export const BOSS_SKINS: BossSkin[] = [
  {
    ...
    flies: false,
    moves: ['leap', 'charge', 'pushSlam', 'roar', 'solarBeam'],
    leapMult: 1.0,
    chargeMult: 1.0,
    hpMult: 1.0,
  ...
  },
  {
    ...
    flies: false,
    moves: ['solarBeam', 'megasmash', 'charge', 'pushSlam', 'laser'],
    leapMult: 1.15,
    chargeMult: 1.1,
    hpMult: 1.2,
  ...
  },
  {
    ...
    flies: false,
    moves: ['charge', 'leap', 'solarBeam', 'summon', 'pushSlam'],
    leapMult: 1.25,
    chargeMult: 1.2,
    hpMult: 1.35,
  ...
  },
  {
    ...
    flies: false,
    moves: ['charge', 'roar', 'pushSlam', 'solarBeam', 'megasmash'],
    leapMult: 1.3,
    chargeMult: 1.3,
    hpMult: 1.45,
...
export const FINAL_BOSS_SKIN: BossSkin = {
  ...
  flies: true,
  moves: ['solarBeam', 'leap', 'fireball', 'charge', 'spin', 'teleport', 'roar', 'laser', 'pushSlam', 'summon'],
  leapMult: 1.4,
  chargeMult: 1.35,
  hpMult: 1.75
};
